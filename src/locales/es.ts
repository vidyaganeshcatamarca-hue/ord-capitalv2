...
error_transfer_different_currencies: "Operación inválida: No se permiten transferencias directas entre cuentas de diferentes monedas ({currency_from} a {currency_to}).",
  ...
  error_category_has_children: "No se puede eliminar: la categoría tiene subcategorías hijas",
  menu_inicio: "Inicio",
...
export const inversiones = {
  ...
  cat_subcuentas_count_one: "{count} subcuenta",
  cat_subcuentas_count_other: "{count} subcuentas",
...
export const tour = {
  ...
  'home.step1.title': 'Tu panorama de hoy',
  'home.step1.description': 'Acá ves tu saldo total y cómo viene el mes.',
  'home.step1.howTo': 'Tocá "Ver detalle" para abrir el desglose por billetera.',
  'home.step2.title': 'Cómo están con tu pareja',
  'home.step2.description': 'Si están en modo hogar, ves el balance entre ustedes.',
  'home.step2.howTo': 'El botón "Saldar" te lleva directo a registrar el pago.',
  'home.step3.title': 'Cuánto podés gastar hoy',
  'home.step3.description': 'Un número diario que considera tus gastos fijos y pendientes.',
  'home.step3.howTo': 'Si querés saber cómo se calcula, tocá "¿Cómo se calcula?".',
  'home.step4.title': 'Alertas importantes',
  'home.step4.description': 'Acá aparecen gastos por clasificar, vencimientos y billeteras en rojo.',
  'home.step4.howTo': 'Tocá la campana para ver el detalle y resolver cada alerta.',
  'home.step5.title': 'Tus últimos movimientos',
  'home.step5.description': 'Acá ves los ingresos y gastos más recientes.',
  'home.step5.howTo': 'Tocá cualquier movimiento para editarlo o ver el detalle.',
  'home.step6.title': 'Registrar un movimiento',
  'home.step6.description': 'Este botón te abre el formulario rápido para anotar un gasto o ingreso.',
  'home.step6.howTo': 'Mantenerlo presionado te da atajos a ingreso, egreso o transferencia.',
  ...
  'cuentas.step1.title': 'Pestañas de vista',
  'cuentas.step1.description': 'Alterná entre lista de cuentas y salud financiera.',
  'cuentas.step1.howTo': 'Tocá cada pestaña para cambiar de vista.',
  'cuentas.step2.title': 'Tus billeteras',
  'cuentas.step2.description': 'Acá ves todas tus cuentas con sus saldos.',
  'cuentas.step2.howTo': 'Tocá una billetera para ver su detalle y movimientos.',
  'cuentas.step3.title': 'Salud de billeteras',
  'cuentas.step3.description': 'Detecta cuentas en rojo, olvidadas o desconciliadas.',
  'cuentas.step3.howTo': 'Revisá este widget seguido para mantener tus cuentas sanas.',
  'cuentas.step4.title': 'Agregar cuenta',
  'cuentas.step4.description': 'Creá una nueva billetera en pesos o dólares.',
  'cuentas.step4.howTo': 'Tocá el botón + para agregar una cuenta nueva.',
  'cuentas.step5.title': 'Conciliar saldo',
  'cuentas.step5.description': 'Ajustá el saldo de la app con el real del banco.',
  'cuentas.step5.howTo': 'Tocá "Conciliar" en cualquier billetera para ajustar.',
  ...
  'tarjetas.step1.title': 'Deuda total',
  'tarjetas.step1.description': 'Acá ves cuánto debés entre todas tus tarjetas.',
  'tarjetas.step1.howTo': 'Tocá el widget para ver el desglose por tarjeta.',
  'tarjetas.step2.title': 'Alertas de vencimiento',
  'tarjetas.step2.description': 'Te avisamos cuando un pago está por vencer.',
  'tarjetas.step2.howTo': 'Revisá esta sección para no olvidar ningún vencimiento.',
  'tarjetas.step3.title': 'Lista de tarjetas',
  'tarjetas.step3.description': 'Acá ves todas tus tarjetas activas y archivadas.',
  'tarjetas.step3.howTo': 'Tocá una tarjeta para ver sus compras en cuotas.',
  'tarjetas.step4.title': 'Nueva tarjeta',
  'tarjetas.step4.description': 'Agregá una tarjeta de crédito para trackear tus cuotas.',
  'tarjetas.step4.howTo': 'Tocá "+ Nueva" para registrar una tarjeta.',
  'tarjetas.step5.title': 'Pagar resumen',
  'tarjetas.step5.description': 'Registrá el pago del resumen de tu tarjeta.',
  'tarjetas.step5.howTo': 'Tocá "Pagar" en el detalle de la tarjeta.',
  ...
  'presupuestos.step1.title': 'Termómetro del mes',
  'presupuestos.step1.description': 'Cuatro barras que muestran cómo vas con tus gastos.',
  'presupuestos.step1.howTo': 'Mirá las barras para ver si vas bien o te estás pasando.',
  'presupuestos.step2.title': 'Saldo a asignar',
  'presupuestos.step2.description': 'Lo que te queda para distribuir este mes.',
  'presupuestos.step2.howTo': 'Asigná este saldo a los sobres que necesiten refuerzo.',
  'presupuestos.step3.title': 'Reglas de oro',
  'presupuestos.step3.description': 'Configurá los porcentajes ideales de tu presupuesto.',
  'presupuestos.step3.howTo': 'Ajustá necesidades, deseos, ahorro y diezmo según tu plan.',
  'presupuestos.step4.title': 'Selector de mes',
  'presupuestos.step4.description': 'Navegá entre meses para ver presupuestos pasados.',
  'presupuestos.step4.howTo': 'Usá las flechas para cambiar de mes.',
  'presupuestos.step5.title': 'Lista de sobres',
  'presupuestos.step5.description': 'Acá ves cada sobre con su presupuesto asignado.',
  'presupuestos.step5.howTo': 'Tocá un sobre para ajustar su monto o ver su detalle.',
  ...
  'ajustes.step1.title': 'Centro de configuración',
  'ajustes.step1.description': 'Acá encontrás todas las opciones de la app.',
  'ajustes.step1.howTo': 'Explorá las tarjetas para configurar cada aspecto.',
  'ajustes.step2.title': 'Preferencias',
  'ajustes.step2.description': 'Ajustá el tema, fuentes y comportamiento general.',
  'ajustes.step2.howTo': 'Tocá "Preferencias" para personalizar la app.',
  'ajustes.step3.title': 'Notificaciones',
  'ajustes.step3.description': 'Configurá qué alertas querés recibir.',
  'ajustes.step3.howTo': 'Activá o desactivá notificaciones según necesites.',
  'ajustes.step4.title': 'Región y formato',
  'ajustes.step4.description': 'Elegí moneda, formato de fecha y zona horaria.',
  'ajustes.step4.howTo': 'Configurá tu región para ver montos en tu formato local.',
  'ajustes.step5.title': 'Acerca de',
  'ajustes.step5.description': 'Versión de la app, créditos y licencias.',
  'ajustes.step5.howTo': 'Consultá esta sección para ver datos de la aplicación.',
};
