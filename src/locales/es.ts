...
error_transfer_different_currencies: "Operación inválida: No se permiten transferencias directas entre cuentas de diferentes monedas ({currency_from} a {currency_to}).",
  ...
  unit_subaccounts_singular: "{count} subcategoría",
  unit_subaccounts_plural: "{count} subcategorías",
  ...
  rubro_hijos_empty: "Sin subcategorías aún",
...
export const inversiones = {
  ...
  cat_subcuentas_count_one: "{count} subcategoría",
  cat_subcuentas_count_other: "{count} subcategorías",
  ...
  cat_child_empty: "Sin subcategorías aún",
