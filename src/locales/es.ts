...
export const tour = {
  ...
  'home.step1.description': 'Acá ves toda tu plata junta de todas tus cuentas y billeteras, en pesos y dólares.',
  'home.step2.title': 'Cómo vienen tus gastos segun las fechas que elijas (hoy, semana, mes, etc)',
  'home.step2.description': 'El círculo muestra el porcentaje de gastos de cada rubro o subrubro.',
  'home.step2.howTo': "'Solo Rubros' te muestra el detalle general de los rubros sin subrubros. 'Ver todos' te muestra los gastos por subrubros.",
  'home.step3.title': 'Boton para ver mas detalles',
  'home.step3.description': 'Por defecto se te muestras 3 categorias.',
  'home.step3.howTo': "Si quieres ver el detalle de todas, elije 'Ver todas'.",
  'home.step4.title': 'Tus billeteras',
  'home.step4.description': 'Acá ves tus cuentas en un carrusel.',
  'home.step4.howTo': "Deslizá horizontalmente para ver más. Tocá 'Conciliar' para ajustar el saldo informado con el real de tu cuenta. Toca 'todas' para seleccionar un filtro por billetera. Eso te mostrará solo las operaciones que efectuaste con esa billetera en particular.",
  'home.step5.title': 'Dinero que falta por diferencias con tu dinero real de tus cuentas.',
  'home.step5.description': 'Posibles olvidos de registro pueden hacer que cuando "concilias" una cuenta lo que dice la app y lo que tenes de verdad no coincida',
  'home.step5.howTo': 'Si ese monto crece mucho, la unica solucion es disciplinarte en el registro de tus ingresos / egresos',
  'home.step6.title': 'Tus últimos movimientos',
  'home.step6.description': 'Acá ves los ingresos y gastos más recientes.',
  'home.step6.howTo': "Tocá un movimiento para editarlo. El botón 'Filtrar' te ayuda a filtrar por rubro o subrubro. toca el 'tachito' para borrar una carga mal hecha",
  'home.step7.title': 'Botones auxiliares',
  'home.step7.description': 'tres accesos rápidos',
  'home.step7.howTo': 'El ícono de pregunta muestra este tour. El ojo oculta los montos (muy importante para mantener tu privacidad ante miradas curiosas mientras tenes la app abierta). La campana muestra tus alertas.',
  'home.step8.title': 'Cargar datos',
  'home.step8.description': 'con este boton cargas tus ingresos y tus egresos',
  'home.step8.howTo': "al hacer click, se abrira una pantalla (por defecto egresos - pero puedes modificarlo desde 'Menu/ajustes/preferencias operativas'. Tambien tienes un acceso directo permanente a cargar movimientos desde las notificaciones de tu movil",
