...
export const tour = {
  ...
  'home.step5.howTo': "Deslizá horizontalmente para ver más. Tocá 'Conciliar' para ajustar el saldo informado con el real de tu cuenta.",
  ...
  'home.step7.description': 'Te avisa si hay plata que falta en tus cuentas por movimientos no registrados.',
  'home.step7.howTo': "Si este monto crece, la solución es disciplinarte en registrar todos tus ingresos y egresos. Tocá el ojito para ocultar este aviso si querés.",
  'home.step8.title': 'Tus últimos movimientos',
  'home.step8.description': 'Acá ves los ingresos y gastos más recientes.',
  'home.step8.howTo': "Tocá un movimiento para editarlo.",
  'home.step9.title': 'Filtrar movimientos',
  'home.step9.description': "Filtrá por rubro, subrubro o billetera.",
  'home.step9.howTo': "Tocá 'Filtrar' y elegí el criterio. Tocá el 'tachito' en un movimiento para borrar una carga mal hecha.",
  'home.step10.title': 'Botones auxiliares',
  'home.step10.description': 'tres accesos rápidos',
  'home.step10.howTo': 'El ícono de pregunta muestra este tour. El ojo oculta los montos (muy importante para mantener tu privacidad ante miradas curiosas mientras tenes la app abierta).',
  'home.step11.title': 'Cargar datos',
  'home.step11.description': 'con este boton cargas tus ingresos y tus egresos',
  'home.step11.howTo': "al hacer click, se abrira una pantalla (por defecto egresos - pero puedes modificarlo desde 'Menu/ajustes/preferencias operativas'. Tambien tienes un acceso directo permanente a cargar movimientos desde las notificaciones de tu movil",
