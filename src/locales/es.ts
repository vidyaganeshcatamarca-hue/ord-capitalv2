...
error_transfer_different_currencies: "Operación inválida: No se permiten transferencias directas entre cuentas de diferentes monedas ({currency_from} a {currency_to}).",
  ...
  btn_reconcile: "Conciliar",
  mystery_leak_warning: "Fugas de Capital (Misterio)",
  ...
  activity_back_to_top: "Volver al inicio",
   ...
   filter_no_categories: "Aún no tenés categorías. Creá una desde el menú Categorías.",
  ...
  card_form_title_edit: "Editar Tarjeta",
  ...
  pay_overpay_favor_restante: "Saldo a favor que queda para el próximo resumen: {total}.",
...
saldo_a_favor_chip: "Saldo a favor: {monto}",
   ...
   error_resumen_sin_cuotas_pendientes: "El resumen elegido ya no tiene cuotas pendientes. Actualizá e intentá de nuevo.",
  ...
  btn_use_email: "Usar Correo Electrónico",
  btn_login: "Ingresar",
...
export const war_room = {
  ...
  war_escudo_titulo: "Escudo de Tiempo",
  ...
  war_podora_titulo: "Podora BCG (Resumen)",
  ...
  war_radar_detalle_pagina_titulo: "Radar de Asfixia",
...
export const saneamiento = {
  ...
  // Audio
  saneamiento_audio_titulo: "Audio",
  saneamiento_audio_titulo_grabar: "Dictar Gasto",
...
export const wallets = {
  ...
  // Health widget
  health_title: "Mantenimiento Requerido ({count})",
...
export const inversiones = {
  ...
  title_create_category: "Crear Categoría",
  ...
  cat_bcg_utilidad_info: "¿Cuanto placer o utilidad te brinda esta categoria? A mayor utilidad/placer, cerca del 10. Por lo contrario, tiende a 1 cuando no tiene mucha utilidad/placer",
  cat_bcg_flexibilidad_info: "¿Cuan facil seria recortar este gasto de tu vida? a mayor valor, mas factible es quitarlo sin esfuerzo. A menor valor, mas dificil es prescindir de ello.",
  cat_bcg_info_button_label: "Mostrar información sobre {label}",
  ...
  reconcile_modal_title: "Conciliar {nombre}",
