...
error_transfer_different_currencies: "Operación inválida: No se permiten transferencias directas entre cuentas de diferentes monedas ({currency_from} a {currency_to}).",
  ...
  pay_overpay_cuota_position: "Cuota {pos} de {total}",
   ...
   pay_multi_total_pendiente: "Falta repartir: {monto}",
     ...
     pay_multi_wallet_placeholder_usd_fallback: "Elegí cuenta (conversión ARS)",
     pay_multi_wallet_usd_fallback_hint: "No tenés cuentas en USD. Elegí una cuenta en ARS para pagar con conversión y recargo.",
     pay_multi_moneda_toggle_label: "Moneda de la cuota a pagar",
     pay_multi_moneda_ars: "$",
     pay_multi_moneda_usd: "US$",
     pay_multi_recargo_preview: "Equivale a {monto} (incluye {pct}% recargo)",
