...
def generate_icons_exact_90():
    ...
    # EXACT 90% SCALE: 418x418 px emblem in 512x512 canvas
    # 1. GREEN BG ICON
    green_bg = Image.new('RGBA', (512, 512), (11, 56, 14, 255))
    scaled_emblem_green = emblem_with_rim.resize((418, 418), Image.Resampling.LANCZOS)
    # Centered at (47, 47)
    green_bg.paste(scaled_emblem_green, (47, 47), scaled_emblem_green)

    # Save to scratch preview
    ...
    print('Generated exact 90% green PWA icons')

    # 2. WHITE BG SHORTCUT ICON (392x392 emblem in 512x512 canvas)
    white_bg = Image.new('RGBA', (512, 512), (255, 255, 255, 255))
    scaled_emblem_white = emblem_with_rim.resize((392, 392), Image.Resampling.LANCZOS)
    # Centered at (60, 60)
    white_bg.paste(scaled_emblem_white, (60, 60), scaled_emblem_white)
    ...
    print('Generated exact 90% white shortcut PWA icons')

if __name__ == '__main__':
    generate_icons_exact_90()
