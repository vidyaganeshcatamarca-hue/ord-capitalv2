...
def generate_icons_90():
    # Source emblem from docs/icons/android-icon-512x512.png
    ...
    # 1. GREEN BG ICON (5% smaller scale -> emblem 408x408 in 512x512 canvas)
    # Background #0B380E (11, 56, 14)
    green_bg = Image.new('RGBA', (512, 512), (11, 56, 14, 255))
    scaled_emblem_green = emblem_with_rim.resize((408, 408), Image.Resampling.LANCZOS)
    # Centered at (52, 52)
    green_bg.paste(scaled_emblem_green, (52, 52), scaled_emblem_green)
    ...
    print('Generated scratch/preview_logo_green_90.png')

    # Save to public PWA icon files
    ...
    print('Updated all green PWA icons in public/ (-5% scale)')

    # 2. WHITE BG SHORTCUT ICON (5% smaller scale -> emblem 380x380 in 512x512 canvas)
    white_bg = Image.new('RGBA', (512, 512), (255, 255, 255, 255))
    scaled_emblem_white = emblem_with_rim.resize((380, 380), Image.Resampling.LANCZOS)
    # Centered at (66, 66)
    white_bg.paste(scaled_emblem_white, (66, 66), scaled_emblem_white)
    ...
    print('Generated scratch/preview_logo_white_90.png')

    # Save to public shortcut icon files
    ...
    print('Updated all white shortcut PWA icons in public/ (-5% scale)')
